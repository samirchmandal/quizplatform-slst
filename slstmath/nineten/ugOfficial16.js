const questions = await fetch('../../.netlify/functions/slstmath/ug/slstUGofficial16').then(response=> response.json())
...
const gasURL = 'https://script.google.com/macros/s/AKfycbzUDA-aMgM31l2lGshqGzaYDVCX7ch9ZnZftmT4RaBtROeVvGY_XmthNeqqvyeyyXuuSA/exec';
    try {
