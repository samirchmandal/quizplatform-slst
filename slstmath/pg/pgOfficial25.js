const questions = await fetch('../../.netlify/functions/slstPGofficial25').then(response=> response.json())
...
const gasURL = 'https://script.google.com/macros/s/AKfycbztg0wpo-gaVF-WXEEFIv47ruvWb-TfdAkRnub6vZW12Jgvw2QQlgH756YqGBO9li83/exec';
    try {
